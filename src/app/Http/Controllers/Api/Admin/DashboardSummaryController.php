 ...
 *   - Today's platform sales / round-up — needs POS app payment data
 *     that does not exist yet.
 *   - Top merchants by revenue — same blocker.
 *   - Reconciliation queue count — needs POS app NFC-timeout writes.
 *   - Device alerts (offline >6h, low battery, out-of-fence) — needs
 *     scalefusion adapter that is on hold until the API is available.
 *
 ...
 * Devices / Audit Log) re-check at the destination.
 */
