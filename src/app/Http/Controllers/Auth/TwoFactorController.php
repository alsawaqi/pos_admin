...
/**
 * Self-service TOTP 2FA enrolment for the signed-in platform admin
 * (Phase D8; blueprint §4.1.1 "Optional two-factor authentication
 * via TOTP for all admin accounts"). Per-user opt-in:
 *
