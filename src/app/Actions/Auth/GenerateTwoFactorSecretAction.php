...
/**
 * Start TOTP enrolment for the signed-in platform admin (Phase D8).
 * Mirror of pos_merchant's action — keep both in sync.
 *
...
final readonly class GenerateTwoFactorSecretAction
{
    ...
    public function handle(User $user): array
    {
        ...
        $issuer = (string) config('pos_admin_auth.two_factor.issuer', 'MITHQAL Admin');
